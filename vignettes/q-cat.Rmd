...
<!-- TODO cite section on good items -->
...
knitr::include_graphics(path = c("q-cat-stage-0.png", "q-cat-stage-1.png", "q-cat-stage-2.png", "q-cat-stage-3.png"))
```
...
We also tried in alternative procedure, where participants first define all categories, and then check all items for each of the categories.
