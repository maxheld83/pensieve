...
Q sorts are sometimes repeated with different conditions of instructions, or at a later time, yielding a three-dimensional array of people-variables, item-cases and condition-times.
Several procedures have been suggested to analyze such data, including target rotations, second-level factor analyses, "spiking" and joint analysis.
...
After appropriate rotation and other preparatory step using custom software for the R statistics package, resultant scores can be readily interpreted as factor arrays, with an additional, vertical dimension indicating the difference over time, or between domains.
