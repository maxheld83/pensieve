...
This is correct, but a curious standard for a science of subjectivity, where we usually prefer false-negatives (neglected, but correct results) over false-positives (retained, but incorrect results).
Entirely compatible with the non-randomness of P and Q-set, eigenvalue-based criteria and parallel analysis do, strictly, constitute sufficient --- not merely necessary --- conditions to identify shared subjectivities.
